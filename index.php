...
<body>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td><a href="cad_pf.php?acao=editar&obj=pessoaFisica&id=<?php echo $linha['pf_id'];?>">Editar</a></td>
            <td><a href="javascript:excluirRegistro('acao.php?acao=excluir&obj=pessoaFisica&id=<?php echo $linha['pf_id']; ?>')">Excluir</a><br></td>
        </tr>
        <?php 
            }
        ?>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td><a href="cad_cont.php?acao=editar&obj=contato&id=<?php echo $linha['cont_id'];?>">Editar</a></td>
            <td><a href="javascript:excluirRegistro('acao.php?acao=excluir&obj=contato&id=<?php echo $linha['cont_id']; ?>')">Excluir</a><br></td>
        </tr>
        <?php 
            }
        ?>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td><a href="cad_cc.php?acao=editar&obj=contaCorrente&id=<?php echo $linha['cc_numero'];?>">Editar</a></td>
            <td><a href="javascript:excluirRegistro('acao.php?acao=excluir&obj=contaCorrente&id=<?php echo $linha['cc_numero']; ?>')">Excluir</a><br></td>
        </tr>
        <?php 
            }
        ?>
